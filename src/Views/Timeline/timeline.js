...
const Home = () => {
	const items = [
...

		{
			...
			contentText:
				"Students can register and submit their applications to mentor organizations. All proposals must be submitted by April 13, 2021 23:45.",
		},
...

		{
			...
			contentText:
				"Mentors review student code samples and determine if the students have successfully completed their Google Summer of Code 2021 project.",
		},
	...
	return (
		<>
			<div className="timeline">
				<Chrono items={items} mode="VERTICAL_ALTERNATING" cardHeight={200} hideControls />
			</div>
			<Link to="/">
				<Button className="back">Go Back to Home Page</Button>
			</Link>
		</>
	);
};
